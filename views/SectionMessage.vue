    ...
    <div>
        ...
        <el-dialog title="填写挂号信息" :visible.sync="orderFormVisible">
            <el-form :model="orderForm" ref="orderForm" :rules="orderRules">
                ...
                <el-form-item label="症状描述" label-width="100px" prop="symptoms">
                    <el-input
                        type="textarea"
                        v-model="orderForm.symptoms"
                        placeholder="请简要描述症状"
                        rows="4"
                    ></el-input>
                </el-form-item>
                ...
                if (valid) {
                    request
                        .get("patient/addOrder", {
                            params: {
                                patient_id: this.orderForm.pId,
                                doctor_id: this.orderForm.dId,
                                appointment_time: 
                                    this.orderForm.orderDate +
                                    " " +
                                    this.orderForm.oTime,
                                symptoms: this.orderForm.symptoms,
                                status: "pending",
                                arId: this.idTime,
                            },
                        })
